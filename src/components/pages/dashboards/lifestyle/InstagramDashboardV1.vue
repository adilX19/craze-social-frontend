...
import InstagramOverviewTab from "/@src/components/partials/instagram/InstagramOverviewTab.vue";
import InstagramContentTab from "/@src/components/partials/instagram/InstagramContentTab.vue";
...
<template>
  ...
  <div class="lifestyle-dashboard lifestyle-dashboard-v1">
    <InstagramHeaderWrapper :customer-data="datasets?.customer_dataset" />
    ...
    <div class="tabs-wrapper">
      ...
      <InstagramOverviewTab v-if="activeTab === 'overview'" :customer-data="datasets?.customer_dataset"
                            :insights-data="datasets?.insights_data"/>
      <InstagramContentTab v-else-if="activeTab === 'analytics'" :customer-data="datasets?.customer_dataset"
                          :competitors-data="datasets?.competitors_dataset" :dataset="datasets"/>
      <InstagramBrandsTab v-else-if="activeTab === 'compare'" :customer-data="datasets?.customer_dataset"
