...
<template>
  <Teleport to="body">
    <div :class="[open && 'is-active', size && `is-${size}`, customClass]" class="modal v-modal">
      <div
      ...
      <div class="modal-content">
        <div class="modal-card">
          ...
          <div class="modal-card-body" :class="[props.tabs && 'has-tabs', hideFooter ? 'no-footer' : '']">
