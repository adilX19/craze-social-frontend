...
import TiktokCloudContainer from "/@src/components/partials/tiktok/TiktokCloudContainer.vue";
        ...
        <div id="mainCard" class="card-grid-item is-sticky my-card margin-top-0">
          ...
          <div class="card-grid-item-footer">
            ...
            <div class="item">
              ...
              <div class="right">
                <span>{{
                  props.customerData?.profile_data.followings
                }}</span>
              </div>
            </div>
            <div class="item">
              ...
              <div class="right">
                <span>{{ props.customerData?.profile_data.videos_count }}</span>
              </div>
            </div>
            <!-- <div class="item">
              <div class="left">
                <div class="account-stats">
                  <span class="dark-inverted">{{ t('paidVideosEngagement') }}</span>
                </div>
              </div>
              <div class="right">
                <span
            ...
            <div class="card-grid-item">
                ...
                <div class="item">
                  ...
                  <div class="meta">
                    ...
                    <a
                      ...
                      >@{{ item.profile_data.tiktok_userhandle }}</a
                    >
                  </div>
                </div>
              </div>
              <div class="card-grid-item-footer">
                ...
                <div class="item">
                  ...
                  <div class="right">
                    <span>{{ item.profile_data.followings }}</span>
                  </div>
                </div>
                <div class="item">
                  <div class="left">
                  ...
                  <div class="right">
                    <span>{{ item.profile_data.videos_count }}</span>
                  </div>
                </div>
                <!-- <div class="item">
                  <div class="left">
        ...
        <div class="column is-6 border-right">
          ...
          <!-- <template v-for="(item, index) in props.customerData?.top_hashtags" :key="index">
            ...
            <progress
              ...
              max="100"
              :value="(item.item_count / props.customerData?.total_hashtag_posts) * 100"
            ></progress>
          </template> -->
