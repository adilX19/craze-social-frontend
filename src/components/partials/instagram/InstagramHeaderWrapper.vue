      ...
      <div class="avatar-and-meta">
        <div>
          <VAvatar
            ...
            />
          <!-- <img
            :src="formatLink(props.customerData?.profile_data.profilePicture)"
            alt=""
        ...
        <div class="header-meta">
          <div class="username-wrap">
            ...
            <div class="badges">
              <VTag
                rounded
                color="info"
                :label="props.customerData?.profile_data.category"
              />
          ...
          <div class="mt-4">
            <h4>{{ t('class') }}: &nbsp; <span style="color: #989898">{{ props.customerData?.profile_data.profile_class }}</span></h4>
          </div>
          <div class="mt-2">
            <h4>
              Account: &nbsp;
